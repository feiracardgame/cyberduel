...
- Registre apenas o que foi efetivamente implementado ou verificado. Indique pendências e limitações quando existirem; não apresente trabalho planejado como concluído.
- Preserve as entradas anteriores e as alterações locais do usuário.
